...
const inputId = computed(() => props.id ?? `idate-${uid}`);

const base =
  "block w-full rounded-md border bg-white text-brand-800 border-sand-300 focus:border-brand-300 focus:ring-1 focus:outline-none";
